...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, RouterOutlet, ProductComponent, UserComponent, Productv2Component, ProductlistComponent, Productlistv3Component, AddproductComponent, Productv4Component, Productlistv4Component, HttpClientModule],
